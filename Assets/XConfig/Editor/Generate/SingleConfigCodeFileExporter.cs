...
{
    public class SingleConfigCodeFileExporter : TextFileExporter
    {
...
";
        ...
        public SingleConfigCodeFileExporter(string outFilePath, ConfigFileImporter importer, ConfigFileContext context) : base(outFilePath)
        {

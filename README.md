...
- [XConfig教程](Assets/Docs/XConfig教程.md)

- [XConfig配置](Assets/Docs/XConfig配置.md)
...
4. **导出二进制文件**。执行Unity菜单【**XConfig/Generate Binary**】，会早Assets\Example\Generate\Bin中生成相应的**hello_world.bytes**二进制文件。每次修改配置表数据后都需要重新导出。
